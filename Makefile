...
hadoop_home := $(addsuffix tools/hadoop-2.7.1, $(current_dir))
spark_home := $(addsuffix tools/spark-1.6.0-bin-hadoop2.6, $(current_dir))
...
download_hadoop:
	...
	cd ${current_dir}tools; wget https://archive.apache.org/dist/hadoop/core/hadoop-2.7.1/hadoop-2.7.1.tar.gz && tar -xvf hadoop-2.7.1.tar.gz && rm -rf hadoop-2.7.1.tar.gz

download_spark:
	mkdir -p ${current_dir}tools
	cd ${current_dir}tools; wget https://archive.apache.org/dist/spark/spark-1.6.0/spark-1.6.0-bin-hadoop2.6.tgz && tar -xvf spark-1.6.0-bin-hadoop2.6.tgz && rm -rf spark-1.6.0-bin-hadoop2.6.tgz
